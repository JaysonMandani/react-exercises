    ...
    handleTaskSubmit: function(formData, type, id) {
      ...
      return (
          React.createElement("div", {className: "task-box"}, 
            React.createElement(TaskList, {taskListNodes:  this.state.tasks, form:  this.state.form, onTaskSubmit:  this.handleTaskSubmit}), 

            React.createElement("hr", null), 
            React.createElement("center", null, React.createElement("h2", null, "Create Task"))
          )
        )
		}
	})
