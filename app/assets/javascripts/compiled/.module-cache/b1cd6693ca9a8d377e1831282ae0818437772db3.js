  ...
  var TaskForm = React.createClass({displayName: "TaskForm",
    handleSubmit: function(event){
      ...
      if (!this.props.task_id) {
        ...
        this.props.onTaskSubmit(formData, this.props.form.action, "PATCH", this.props.task_id);
      }
    ...
    render: function() {
      return (
        React.createElement("form", {ref: "form", className: "task-form", action:  this.props.form.action, "accept-charset": "UTF-8", onSubmit:  this.handleSubmit}, 
